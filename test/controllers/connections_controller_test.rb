...
class ConnectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create connection" do
    assert_difference('Connection.count') do
      post connections_url, params: { connection: { leaf_id: @connection.leaf_id, tree_id: @connection.tree_id } }
    end
  ...
  test "should update connection" do
    patch connection_url(@connection), params: { connection: { leaf_id: @connection.leaf_id, tree_id: @connection.tree_id } }
